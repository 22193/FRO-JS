...
var part4 = {
    ...
    instruction1: function () {
        ...
        var student = {name: "Yosef East", group: "MD2", lesson: "FRO"};

        // Zorg ervoor dat de opdracht goed wordt uitgevoerd en dat de content wordt bijgewerkt.
        var result = "Student " + student.name + " zit in groep " + student.group + " en zijn eerste les is " + student.lesson;
    ...
    instruction2: function () {
        ...
        // Zorg ervoor dat de opdracht goed wordt uitgevoerd en dat de content wordt bijgewerkt.
        // var trstarray = studentsArray.trim();
        var obj = {}
        var stringy = JSON.stringify(studentsArray);
        var result = stringy;
